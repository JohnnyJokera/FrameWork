...
public class HomePage {
	...
	// -------------------------------------------------------------------------------------------------------
	// --------------------------------For Bread Maker--------------------------------------------------------
	private static final String filterOfWidth = "is_empty_items";
	...
	// ------------------------------------------Bread Maker----------------------------------------------------
	@FindBy(className = filterOfWidth)
	...
	public static void goToProductPage(WebDriver driver, String product) {
		driver.findElement(By.linkText(product)).click();
	}

	public static void selectItemBreadMaker(WebDriver driver, String filter) {
	...
	public static void selectConditioner(WebDriver driver, String product) {
		...
		driver.findElement(By.xpath(commonBlock))
				.findElement(By.linkText(product)).click();
